...
output: main.o sw.o node.o teach.o analyse.o menu.o sigmoid.o bmp_generator.o image_analyse.o
	gcc main.c sw.c node.c teach.c analyse.c menu.c sigmoid.c bmp_generator.c image_analyse.c -lm -o output
